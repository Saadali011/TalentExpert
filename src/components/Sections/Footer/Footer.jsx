...
const Footer = () => {
    ...
    return (
        <div className={`${footer_container} container-fluid  px-3 px-md-3 px-lg-5  pt-0  pb-2`} style={{ backgroundColor: "#F8F8F4" }}>
            <div className="row px-0 px-md- py-0  " >
            
                <div className="col-lg-6  col-md-6 col-sm-12 " >
                <div className="col-lg-12 mt-sm-3 p-0  pb-sm-4 " >
                        <img src={footerlogo} alt="Talent Expert" />
                    </div>
                    ...
                    <div className="row  px-3 d-flex justify-content-center justify-content-lg-start  d-md-none">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 px-sm-5 px-md-0  pt-sm-4 "
                    style={{
                ...
                >
                       <div className="row">
                       <div className='col-lg-12 mt-sm-3 text-center text-md-left px-3 p-0 ' style={{ color: "#160A54" }}><h3>Our Branches</h3></div>
                       </div>
                    <div className="row px-3    p-0 p-sm-0" style={{ color: "#160A54" }}>
                    ...
                    <div className="row px-3" style={{ color: "#160A54"}}>
                        <div className="col-12 col-md-4 p-0 pt-2 " >
                            <h5 className='d-sm-block  d-none' style={{ color: "#160A54",  }}>Newsletter Sign Up</h5>
                            <h5 className='text-center d-sm-none d-block mb-2' style={{ color: "#160A54",  }}>Newsletter Sign Up</h5>
                        </div>
