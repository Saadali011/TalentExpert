        ...
        <div className="row" style={{ backgroundColor: '#d5d0ef' }}>
          <div className="col-8  ">
            <Link className="pointer " to={"/"} smooth={true}>
              <img src={Logosvg} className="" alt="" srcSet=""
               style={{ width: '100%', height: 'auto' }}
                />
            </Link>
          </div>
          <div className="col-2 p-0"></div>
          <div className="col-2 d-flex justify-content-spaceBetween p-0 align-items-center">
              ...
              <li key={index} className=" pointer ">
                ...
                >
                  <span
                    ...
                    className="animated_link align-items-center"
